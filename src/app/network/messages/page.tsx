...
import { Search, Send, Phone, Video, MoreVertical, Plus, Users, MessageSquare } from "lucide-react"
                  ...
                  {joinedCommunities
                    ...
                    .map((community) => (
                      <Link
                        ...
                        className="block"
                      >
                        <div className="flex items-center gap-3 p-3 rounded-lg cursor-pointer transition-colors hover:bg-[oklch(0.22_0_0)]/50 group">
                          <div className="relative">
                            ...
                            <div className="absolute bottom-0 right-0 w-3 h-3 bg-[oklch(0.75_0.15_85)] rounded-full border-2 border-card flex items-center justify-center">
                              <Users className="w-2 h-2 text-[oklch(0.12_0_0)]" />
                            </div>
                          </div>
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center justify-between">
                              ...
                              <Badge variant="outline" className="ml-2 text-xs border-[oklch(0.75_0.15_85)]/30 text-[oklch(0.75_0.15_85)]">
                                Community
                              </Badge>
                            </div>
                          </div>
